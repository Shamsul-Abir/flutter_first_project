...
class module_9_class_2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length:
          3, //also add length while adding tabs - it show how many tabs are there
      child: Scaffold(
        //add widget - 'DefaultTabController'  in Scaffold while building Tabs in Apps
        appBar: AppBar(
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      backgroundImage: NetworkImage(
                        'https://avatars.githubusercontent.com/u/79713806?s=400&u=88e6b0787dc417806100bfd65b72c36b12725005&v=4',
                      ),
                    ), //puts image in a circle
                    SizedBox(height: 10),
                    Text(
                      'Md. Shamsul Arefin Abir',
                      style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                      ),
